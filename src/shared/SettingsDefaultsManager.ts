...
export interface SettingsDefaults {
  ...
  CLAUDE_MEM_CUSTOM_MAX_OUTPUT_TOKENS: string;
  ...
  CLAUDE_MEM_SEMANTIC_INJECT_SUMMARY_THRESHOLD: string;
...
export class SettingsDefaultsManager {
  private static readonly DEFAULTS: SettingsDefaults = {
    ...
    CLAUDE_MEM_CUSTOM_TEMPERATURE: '',
    CLAUDE_MEM_CUSTOM_MAX_OUTPUT_TOKENS: '',
    ...
    CLAUDE_MEM_SEMANTIC_INJECT_SUMMARY_THRESHOLD: '0.65',
    // Calibration recommender paused by default until Probe B lands a validated content-reuse signal —
    // current likelyHelpedRate fires on path-overlap signals at observation generation, not on
    // injected-content reuse (2026-04 audit found 12/15 "likely_helped" samples were tautologies).
