...
export class OpenRouterAgent {
  ...
  private async processObservationMessage(
    session: ActiveSession,
    message: { prompt_number?: number; tool_name?: string; tool_input?: unknown; tool_response?: unknown; cwd?: string; last_assistant_message?: string },
