...
export interface ActiveSession {
  ...
  currentProvider: 'claude' | 'gemini' | 'openrouter' | 'custom' | null;
  consecutiveRestarts: number;
  restartGuard?: RestartGuard;
  forceInit?: boolean;
  idleTimedOut?: boolean;
  lastGeneratorActivity: number;
  // Track IDs of messages currently being processed; confirmed (deleted) after successful storage.
  processingMessageIds: number[];
  // Summary circuit-breaker counter (#1633): increments on bad summary responses, gates the model.
