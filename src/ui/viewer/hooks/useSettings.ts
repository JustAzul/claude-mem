    ...
    fetch(API_ENDPOINTS.SETTINGS)
      ...
      .then(data => {
        ...
        setSettings({
          ...
          CLAUDE_MEM_CUSTOM_TEMPERATURE: data.CLAUDE_MEM_CUSTOM_TEMPERATURE ?? DEFAULT_SETTINGS.CLAUDE_MEM_CUSTOM_TEMPERATURE,
          CLAUDE_MEM_CUSTOM_MAX_OUTPUT_TOKENS: data.CLAUDE_MEM_CUSTOM_MAX_OUTPUT_TOKENS ?? DEFAULT_SETTINGS.CLAUDE_MEM_CUSTOM_MAX_OUTPUT_TOKENS,
