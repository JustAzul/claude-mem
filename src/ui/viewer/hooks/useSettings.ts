    ...
    fetch(API_ENDPOINTS.SETTINGS)
      ...
      .then(data => {
        ...
        setSettings({
          ...
          CLAUDE_MEM_SEMANTIC_INJECT: data.CLAUDE_MEM_SEMANTIC_INJECT ?? DEFAULT_SETTINGS.CLAUDE_MEM_SEMANTIC_INJECT,
          CLAUDE_MEM_SEMANTIC_INJECT_LIMIT: data.CLAUDE_MEM_SEMANTIC_INJECT_LIMIT ?? DEFAULT_SETTINGS.CLAUDE_MEM_SEMANTIC_INJECT_LIMIT,
          CLAUDE_MEM_SEMANTIC_INJECT_THRESHOLD: data.CLAUDE_MEM_SEMANTIC_INJECT_THRESHOLD ?? DEFAULT_SETTINGS.CLAUDE_MEM_SEMANTIC_INJECT_THRESHOLD,
          CLAUDE_MEM_RECOMMENDER_PAUSED: data.CLAUDE_MEM_RECOMMENDER_PAUSED ?? DEFAULT_SETTINGS.CLAUDE_MEM_RECOMMENDER_PAUSED,
        });
      })
      .catch(error => {
