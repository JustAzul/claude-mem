"use strict";var Zs=Object.create;var le=Object.defineProperty;var en=Object.getOwnPropertyDescriptor;var tn=Object.getOwnPropertyNames;var sn=Object.getPrototypeOf,nn=Object.prototype.hasOwnProperty;var rn=(t,e)=>{for(var s in e)le(t,s,{get:e[s],enumerable:!0})},at=(t,e,s,n)=>{if(e&&typeof e=="object"||typeof e=="function")for(let r of tn(e))!nn.call(t,r)&&r!==s&&le(t,r,{get:()=>e[r],enumerable:!(n=en(e,r))||n.enumerable});return t};var G=(t,e,s)=>(s=t!=null?Zs(sn(t)):{},at(e||!t||!t.__esModule?le(s,"default",{value:t,enumerable:!0}):s,t)),on=t=>at(le({},"__esModule",{value:!0}),t);var zn={};rn(zn,{generateContext:()=>ot});module.exports=on(zn);var Ks=G(require("path"),1),Js=require("os"),zs=require("fs");var rs=require("bun:sqlite");var A=require("path"),$e=require("os"),ue=require("fs");var lt=require("url");var $=require("fs"),z=require("path"),dt=require("os"),Ue=(o=>(o[o.DEBUG=0]="DEBUG",o[o.INFO=1]="INFO",o[o.WARN=2]="WARN",o[o.ERROR=3]="ERROR",o[o.SILENT=4]="SILENT",o))(Ue||{}),ct=(0,z.join)((0,dt.homedir)(),".claude-mem"),ke=class{level=null;useColor;logFilePath=null;logFileInitialized=!1;constructor(){this.useColor=process.stdout.isTTY??!1}ensureLogFileInitialized(){if(!this.logFileInitialized){this.logFileInitialized=!0;try{let e=(0,z.join)(ct,"logs");(0,$.existsSync)(e)||(0,$.mkdirSync)(e,{recursive:!0});let s=new Date().toISOString().split("T")[0];this.logFilePath=(0,z.join)(e,`claude-mem-${s}.log`)}catch(e){console.error("[LOGGER] Failed to initialize log file:",e instanceof Error?e.message:String(e)),this.logFilePath=null}}}getLevel(){if(this.level===null)try{let e=(0,z.join)(ct,"settings.json");if((0,$.existsSync)(e)){let s=(0,$.readFileSync)(e,"utf-8"),r=(JSON.parse(s).CLAUDE_MEM_LOG_LEVEL||"INFO").toUpperCase();this.level=Ue[r]??1}else this.level=1}catch(e){console.error("[LOGGER] Failed to load log level from settings:",e instanceof Error?e.message:String(e)),this.level=1}return this.level}correlationId(e,s){return`obs-${e}-${s}`}sessionId(e){return`session-${e}`}formatData(e){if(e==null)return"";if(typeof e=="string")return e;if(typeof e=="number"||typeof e=="boolean")return e.toString();if(typeof e=="object"){if(e instanceof Error)return this.getLevel()===0?`${e.message}
${e.stack}`:e.message;if(Array.isArray(e))return`[${e.length} items]`;let s=Object.keys(e);return s.length===0?"{}":s.length<=3?JSON.stringify(e):`{${s.length} keys: ${s.slice(0,3).join(", ")}...}`}return String(e)}formatTool(e,s){if(!s)return e;let n=s;if(typeof s=="string")try{n=JSON.parse(s)}catch{n=s}if(e==="Bash"&&n.command)return`${e}(${n.command})`;if(n.file_path)return`${e}(${n.file_path})`;if(n.notebook_path)return`${e}(${n.notebook_path})`;if(e==="Glob"&&n.pattern)return`${e}(${n.pattern})`;if(e==="Grep"&&n.pattern)return`${e}(${n.pattern})`;if(n.url)return`${e}(${n.url})`;if(n.query)return`${e}(${n.query})`;if(e==="Task"){if(n.subagent_type)return`${e}(${n.subagent_type})`;if(n.description)return`${e}(${n.description})`}return e==="Skill"&&n.skill?`${e}(${n.skill})`:e==="LSP"&&n.operation?`${e}(${n.operation})`:e}formatTimestamp(e){let s=e.getFullYear(),n=String(e.getMonth()+1).padStart(2,"0"),r=String(e.getDate()).padStart(2,"0"),o=String(e.getHours()).padStart(2,"0"),i=String(e.getMinutes()).padStart(2,"0"),a=String(e.getSeconds()).padStart(2,"0"),c=String(e.getMilliseconds()).padStart(3,"0");return`${s}-${n}-${r} ${o}:${i}:${a}.${c}`}log(e,s,n,r,o){if(e<this.getLevel())return;this.ensureLogFileInitialized();let i=this.formatTimestamp(new Date),a=Ue[e].padEnd(5),c=s.padEnd(6),d="";r?.correlationId?d=`[${r.correlationId}] `:r?.sessionId&&(d=`[session-${r.sessionId}] `);let l="";o!=null&&(o instanceof Error?l=this.getLevel()===0?`
${o.message}
${o.stack}`:` ${o.message}`:this.getLevel()===0&&typeof o=="object"?l=`
`+JSON.stringify(o,null,2):l=" "+this.formatData(o));let p="";if(r){let{sessionId:b,memorySessionId:y,correlationId:N,...E}=r;Object.keys(E).length>0&&(p=` {${Object.entries(E).map(([f,R])=>`${f}=${R}`).join(", ")}}`)}let g=`[${i}] [${a}] [${c}] ${d}${n}${p}${l}`;if(this.logFilePath)try{(0,$.appendFileSync)(this.logFilePath,g+`
`,"utf8")}catch(b){process.stderr.write(`[LOGGER] Failed to write to log file: ${b instanceof Error?b.message:String(b)}
...
`)[2]||"").match(/at\s+(?:.*\s+)?\(?([^:]+):(\d+):(\d+)\)?/),l=d?`${d[1].split("/").pop()}:${d[2]}`:"unknown",p={...n,location:l};return this.warn(e,`[HAPPY-PATH] ${s}`,p,r),o}},u=new ke;var un={};function an(){return typeof __dirname<"u"?__dirname:(0,A.dirname)((0,lt.fileURLToPath)(un.url))}var cn=an();function dn(){if(process.env.CLAUDE_MEM_DATA_DIR)return process.env.CLAUDE_MEM_DATA_DIR;let t=(0,A.join)((0,$e.homedir)(),".claude-mem"),e=(0,A.join)(t,"settings.json");try{if((0,ue.existsSync)(e)){let{readFileSync:s}=require("fs"),n=JSON.parse(s(e,"utf-8")),r=n.env??n;if(r.CLAUDE_MEM_DATA_DIR)return r.CLAUDE_MEM_DATA_DIR}}catch{}return t}var x=dn(),V=process.env.CLAUDE_CONFIG_DIR||(0,A.join)((0,$e.homedir)(),".claude"),sr=(0,A.join)(V,"plugins","marketplaces","thedotmack"),nr=(0,A.join)(x,"archives"),rr=(0,A.join)(x,"logs"),or=(0,A.join)(x,"trash"),ir=(0,A.join)(x,"backups"),ar=(0,A.join)(x,"modes"),cr=(0,A.join)(x,"settings.json"),ut=(0,A.join)(x,"claude-mem.db"),dr=(0,A.join)(x,"vector-db"),ln=(0,A.join)(x,"observer-sessions"),Fe=(0,A.basename)(ln),lr=(0,A.join)(V,"settings.json"),ur=(0,A.join)(V,"commands"),_r=(0,A.join)(V,"CLAUDE.md");function _t(t){(0,ue.mkdirSync)(t,{recursive:!0})}function mt(){return(0,A.join)(cn,"..")}var bt=require("crypto");var Et=require("os"),gt=G(require("path"),1);var me=require("fs"),_e=G(require("path"),1),Q={isWorktree:!1,worktreeName:null,parentRepoPath:null,parentProjectName:null};function pt(t){let e=_e.default.join(t,".git"),s;try{s=(0,me.statSync)(e)}catch(l){return l instanceof Error&&l.code!=="ENOENT"&&console.warn("[worktree] Unexpected error checking .git:",l),Q}if(!s.isFile())return Q;let n;try{n=(0,me.readFileSync)(e,"utf-8").trim()}catch(l){return console.warn("[worktree] Failed to read .git file:",l instanceof Error?l.message:String(l)),Q}let r=n.match(/^gitdir:\s*(.+)$/);if(!r)return Q;let i=r[1].match(/^(.+)[/\\]\.git[/\\]worktrees[/\\]([^/\\]+)$/);if(!i)return Q;let a=i[1],c=_e.default.basename(t),d=_e.default.basename(a);return{isWorktree:!0,worktreeName:c,parentRepoPath:a,parentProjectName:d}}function Tt(t){return t==="~"||t.startsWith("~/")?t.replace(/^~/,(0,Et.homedir)()):t}function _n(t){if(!t||t.trim()==="")return u.warn("PROJECT_NAME","Empty cwd provided, using fallback",{cwd:t}),"unknown-project";let e=Tt(t),s=gt.default.basename(e);if(s===""){if(process.platform==="win32"){let r=t.match(/^([A-Z]):\\/i);if(r){let i=`drive-${r[1].toUpperCase()}`;return u.info("PROJECT_NAME","Drive root detected",{cwd:t,projectName:i}),i}}return u.warn("PROJECT_NAME","Root directory detected, using fallback",{cwd:t}),"unknown-project"}return s}function je(t){let e=_n(t);if(!t)return{primary:e,parent:null,isWorktree:!1,allProjects:[e]};let s=Tt(t),n=pt(s);if(n.isWorktree&&n.parentProjectName){let r=`${n.parentProjectName}/${e}`;return{primary:r,parent:n.parentProjectName,isWorktree:!0,allProjects:[n.parentProjectName,r]}}return{primary:e,parent:null,isWorktree:!1,allProjects:[e]}}var mn=3e4;function pe(t,e,s){return(0,bt.createHash)("sha256").update([t||"",e||"",s||""].join("\0")).digest("hex").slice(0,16)}function Ee(t,e,s){let n=s-mn;return t.prepare("SELECT id, created_at_epoch FROM observations WHERE content_hash = ? AND created_at_epoch > ?").get(e,n)}var pn=[{name:"anthropic_key",re:/sk-ant-[A-Za-z0-9_-]{20,}/g},{name:"openai_key",re:/sk-(?:proj-)?[A-Za-z0-9_-]{20,}/g},{name:"github_token",re:/gh[pousr]_[A-Za-z0-9]{36,}/g},{name:"aws_access_key",re:/\bAKIA[0-9A-Z]{16}\b/g},{name:"jwt",re:/\beyJ[A-Za-z0-9_-]{10,}\.[A-Za-z0-9_-]{10,}\.[A-Za-z0-9_-]{10,}\b/g},{name:"bearer_token",re:/\bBearer\s+[A-Za-z0-9._-]{20,}/gi},{name:"named_secret",re:/\b(?:api[_-]?key|secret|password|passwd|access[_-]?token|refresh[_-]?token)\s*[:=]\s*["']?([^\s"'&;]{6,})/gi}];function ft(t){let e=t;for(let{re:s}of pn)e=e.replace(s,n=>{let r=n.search(/[:=]/);return r>-1&&/\b(?:api[_-]?key|secret|password|passwd|access[_-]?token|refresh[_-]?token)/i.test(n.slice(0,r))?n.slice(0,r+1)+"[REDACTED]":"[REDACTED]"});return e}function F(t){return t==null?t:ft(t)}function ge(t,e,s,n,r){if(!e){u.warn("DB","insertCaptureSnapshot: missing observationId \u2014 skipping");return}try{t.prepare(`
    ...
    `).run(e,s.memorySessionId,s.contentSessionId,s.promptNumber,F(s.userPrompt),F(s.priorAssistantMessage),s.toolName,F(s.toolInput),F(s.toolOutput),s.cwd,n.type,n.llmRawType,F(n.title),F(n.subtitle),F(n.narrative),n.facts,n.concepts,F(n.why),F(n.alternativesRejected),n.relatedObservationIds,r)}catch(o){u.warn("DB","insertCaptureSnapshot failed \u2014 observation persisted without snapshot",{observationId:e},o instanceof Error?o:void 0)}}function Te(t,e,s){return{memorySessionId:t,contentSessionId:e,promptNumber:s,userPrompt:null,priorAssistantMessage:null,toolName:null,toolInput:null,toolOutput:null,cwd:null}}function be(t){return{type:t.type,llmRawType:t.pre_gate_type??null,title:t.title,subtitle:t.subtitle,narrative:t.narrative,facts:JSON.stringify(t.facts??[]),concepts:JSON.stringify(t.concepts??[]),why:t.why??null,alternativesRejected:t.alternatives_rejected??null,relatedObservationIds:t.related_observation_ids&&t.related_observation_ids.length>0?JSON.stringify(t.related_observation_ids):null}}function Pe(t){if(!t)return[];try{let e=JSON.parse(t);return Array.isArray(e)?e:[String(e)]}catch{return[t]}}function ht(t,e,s,n,r){if(e.length===0)return;u.debug(`[observation-feedback] recording ${s} for ${e.length} observations`);let o=t.prepare(`
  ...
  `),i=t.prepare(`
    ...
    WHERE id = ?
  `),a=Date.now(),c=r?JSON.stringify(r):null;t.transaction(l=>{for(let p of l)o.run(p,s,n??null,a,c),s==="memory_assist_helpful"&&i.run(p)})(e)}function fe(t,e=30){let s={windowDays:e,helpful:0,notHelpful:0,bySource:{}},n=Date.now()-e*24*60*60*1e3,r=t.prepare(`
  ...
  `).all(n);for(let o of r){let i="unknown";if(o.metadata)try{i=JSON.parse(o.metadata).source||i}catch{}s.bySource[i]||(s.bySource[i]={helpful:0,notHelpful:0}),o.signal_type==="memory_assist_helpful"?(s.helpful+=1,s.bySource[i].helpful+=1):(s.notHelpful+=1,s.bySource[i].notHelpful+=1)}return u.debug(`[observation-feedback] loaded feedback stats for ${e}d window (${r.length} rows)`),s}var v="claude";function En(t){return t.trim().toLowerCase().replace(/\s+/g,"-")}function Y(t){if(!t)return v;let e=En(t);return e?e==="transcript"||e.includes("codex")?"codex":e.includes("cursor")?"cursor":e.includes("claude")?"claude":e:v}function St(t){let e=["claude","codex","cursor"];return[...t].sort((s,n)=>{let r=e.indexOf(s),o=e.indexOf(n);return r!==-1||o!==-1?r===-1?1:o===-1?-1:r-o:s.localeCompare(n)})}var he=G(require("path"),1);function Se(t){if(!t)return[];try{let e=JSON.parse(t);return Array.isArray(e)?e:[]}catch(e){return u.debug("PARSER","Failed to parse JSON array, using empty fallback",{preview:t?.substring(0,50)},e instanceof Error?e:new Error(String(e))),[]}}function Xe(t){return new Date(t).toLocaleString("en-US",{month:"short",day:"numeric",hour:"numeric",minute:"2-digit",hour12:!0})}function Oe(t){return new Date(t).toLocaleString("en-US",{hour:"numeric",minute:"2-digit",hour12:!0})}function Ge(t){return new Date(t).toLocaleString("en-US",{month:"short",day:"numeric",year:"numeric"})}function Ot(t,e){return he.default.isAbsolute(t)?he.default.relative(e,t):t}function Rt(t,e,s){let n=Se(t);if(n.length>0)return Ot(n[0],e);if(s){let r=Se(s);if(r.length>0)return Ot(r[0],e)}return"General"}function gn(t){return t?Math.ceil(t.length/4):0}function yt(t,e){if(!t?.length)return 0;let s=new Set(t.map(i=>i.createdAtEpoch?Ge(i.createdAtEpoch):null).filter(i=>!!i)),n=[`This file has prior observations. ${e?`File: ${he.default.basename(e)}.`:""}`.trim(),"- Already know enough? The timeline below may be all you need.","- Need details? get_observations([IDs])."],r=t.map(i=>{let a=i.createdAtEpoch?Oe(i.createdAtEpoch):"",c=(i.title||"Untitled").replace(/[\r\n\t]+/g," ").replace(/\s+/g," ").trim().slice(0,160);return`${i.observationId} ${a} ${i.type??"discovery"} ${c}`.trim()}),o=[...n,...Array.from(s).map(i=>`### ${i}`),...r].join(`
`);return gn(o)}function q(t,e){if(!t)return e;try{return JSON.parse(t)}catch{return e}}function H(t){return t==null?null:JSON.stringify(t)}function At(t){t.run(`
  ...
  `).run(e.source,e.status,e.reason,e.project??null,e.platformSource??null,e.sessionDbId??null,e.contentSessionId??null,e.promptNumber??null,e.threshold??null,e.bestDistance??null,e.worstDistance??null,e.candidateCount??null,e.selectedCount??null,e.promptLength??null,e.filePath??null,e.message??null,e.estimatedInjectedTokens??null,H(e.traceItems??[]),H(e.selectedIds??null),H(e.shadowRanking??null),e.systemVerdict??null,e.systemConfidence??null,H(e.systemReasons??[]),H(e.systemEvidence??null),e.userFeedback??null,s,s),o=Tn(t,Number(r.lastInsertRowid));return u.debug(`[memory-assist-decisions] stored decision ${o.id??"unknown"}`),o}function Tn(t,e){let s=t.prepare(`
    ...
    WHERE id = ?
  `).get(e);return s?Re(s):null}function Z(t,e={}){let s=Math.min(Math.max(e.limit??20,1),1e4),n=[],r=[];e.windowDays&&(n.push("created_at_epoch >= ?"),r.push(Date.now()-e.windowDays*24*60*60*1e3)),e.source&&(n.push("source = ?"),r.push(e.source)),e.project&&(n.push("project = ?"),r.push(e.project)),e.contentSessionId&&(n.push("content_session_id = ?"),r.push(e.contentSessionId));let o=n.length>0?`WHERE ${n.join(" AND ")}`:"",a=t.prepare(`
    SELECT *
    FROM memory_assist_decisions
    ${o}
    ORDER BY created_at_epoch DESC
    LIMIT ${s}
  `).all(...r).map(Re);return u.debug(`[memory-assist-decisions] loaded ${a.length} recent decisions (limit=${s})`),a}function It(t,e,s,n,r=Date.now()){let i=r-n,a=r+100;return t.prepare(`
    SELECT *
    FROM memory_assist_decisions
    WHERE content_session_id = ?
      ...
      AND created_at_epoch <= ?
    ORDER BY created_at_epoch DESC
  `).all(e,s,i,a).map(Re)}function vt(t,e,s,n,r,o){t.prepare(`
    ...
    SET system_verdict = ?,
        ...
        updated_at_epoch = ?
    WHERE id = ?
  `).run(s,n,H(r),H(o),Date.now(),e)}function Ct(t,e,s){t.prepare(`
    UPDATE memory_assist_decisions
    SET user_feedback = ?,
        updated_at_epoch = ?
    WHERE id = ?
  `).run(s,Date.now(),e)}function Mt(t,e,s,n){let r=s-n,o=t.prepare(`
    ...
    WHERE content_session_id = ?
      ...
      AND prompt_number >= ?
      AND prompt_number < ?
  `).all(e,r,s),i=new Set;for(let a of o){let c=q(a.selected_ids_json,[]);for(let d of c)Number.isFinite(d)&&d>0&&i.add(d)}return i}function He(t,e){if(e.length===0)return[];let s=e.map(()=>"?").join(", ");return t.prepare(`
    SELECT *
    FROM memory_assist_decisions
    WHERE id IN (${s})
  `).all(...e).map(Re)}function ee(t,e){if(!t)return e;try{return JSON.parse(t)}catch{return e}}function te(t){return t==null?null:JSON.stringify(t)}function Dt(t){t.run(`
  ...
  `).run(e.decisionId??null,e.pendingMessageId??null,e.source??null,e.promptNumber??null,e.contentSessionId??null,e.sessionDbId??null,e.project??null,e.platformSource??null,e.signalType,e.toolName,e.action,e.filePath??null,te(e.relatedFilePaths??[]),te(e.concepts??[]),te(e.generatedObservationIds??[]),te(e.metadata??{}),s),r=t.prepare(`
    SELECT *
    FROM memory_assist_outcome_signals
    WHERE id = ?
  `).get(Number(n.lastInsertRowid)),o=r?Lt(r):{...e,id:Number(n.lastInsertRowid),timestamp:s};return u.debug(`[memory-assist-outcomes] stored outcome signal ${o.id??"unknown"}`),o}function xt(t,e,s){return s.length===0?[]:t.transaction(()=>{let n=t.prepare(`
      SELECT id, generated_observation_ids_json
      FROM memory_assist_outcome_signals
      WHERE pending_message_id = ?
      ORDER BY id DESC
      LIMIT 1
    `).get(e);if(!n)return u.debug(`[memory-assist-outcomes] no outcome signal found for pending message ${e}`),[];let r=ee(n.generated_observation_ids_json,[]),o=[...new Set([...r,...s])];return t.prepare(`
      UPDATE memory_assist_outcome_signals
      SET generated_observation_ids_json = ?
      WHERE id = ?
    `).run(te(o),n.id),u.debug(`[memory-assist-outcomes] attached ${s.length} observations to pending message ${e}`),o})()}function Ut(t,e){if(e.length===0)return{};let s=e.map(()=>"?").join(", "),n=t.prepare(`
    SELECT *
    FROM memory_assist_outcome_signals
    WHERE decision_id IN (${s})
    ORDER BY created_at_epoch ASC
  `).all(...e),r=n.reduce((o,i)=>{let a=i.decision_id;return a==null||(o[a]||(o[a]=[]),o[a].push(Lt(i))),o},{});return u.debug(`[memory-assist-outcomes] loaded ${n.length} outcome signals for ${e.length} decisions`),r}function Be(t,e){if(!t)return e;try{return JSON.parse(t)}catch{return e}}var bn="__context__",fn="other";function ye(t){return{id:t.id,observationId:t.observation_id,pendingMessageId:t.pending_message_id,decisionId:t.decision_id,contentSessionId:t.content_session_id??void 0,sessionDbId:t.session_db_id??void 0,promptNumber:t.prompt_number??void 0,toolName:t.tool_name,action:t.action,filePath:t.file_path,createdAtEpoch:t.created_at_epoch,contextType:t.context_type??null,contextRef:Be(t.context_ref_json??null,null)}}function kt(t){t.run(`
  ...
  `),t.run("CREATE UNIQUE INDEX IF NOT EXISTS idx_observation_tool_origins_observation_pending_context ON observation_tool_origins(observation_id, COALESCE(pending_message_id, -1), COALESCE(context_type, ''))"),t.run("CREATE INDEX IF NOT EXISTS idx_observation_tool_origins_observation ON observation_tool_origins(observation_id)"),t.run("CREATE INDEX IF NOT EXISTS idx_observation_tool_origins_pending ON observation_tool_origins(pending_message_id)"),t.run("CREATE INDEX IF NOT EXISTS idx_observation_tool_origins_context_type ON observation_tool_origins(context_type)")}function We(t,e,s){if(s.length===0)return[];let n=t.prepare(`
    SELECT
      id,
      pending_message_id,
      decision_id,
  ...
  `).all(e,...o);return u.debug("DB",`memory-assist-origins: attached ${d.length} observation origins for pending message ${e}`),d.map(ye)}function $t(t,e){let s=t.prepare(`
    SELECT *
    FROM observation_tool_origins
    WHERE observation_id = ?
    ORDER BY id DESC
    LIMIT 1
  `).get(e);return s?ye(s):null}function Ft(t,e,s,n,r=Date.now()){if(!Number.isFinite(e)||e<=0)return u.warn("DB",`memory-assist-origins: insertContextOrigin: invalid observationId=${e} \u2014 skipping`),null;let o=n.contentSessionId??n.content_session_id??null,i=n.sessionDbId??n.session_db_id??null,a=n.promptNumber??n.prompt_number??null;t.prepare(`
  ...
  `).run(e,o,i,a,bn,fn,r,s,JSON.stringify(n));let d=t.prepare(`
    SELECT *
    FROM observation_tool_origins
    WHERE observation_id = ? AND context_type = ?
    ORDER BY id DESC
    LIMIT 1
  `).get(e,s);return d?ye(d):(u.debug("DB",`memory-assist-origins: insertContextOrigin: no row materialized for obs=${e} (already existed?)`),null)}function jt(t,e){return t.prepare(`
    SELECT *
    FROM observation_tool_origins
    WHERE observation_id = ?
    ORDER BY id ASC
  `).all(e).map(ye)}function Pt(t,e={}){let s=e.limit??200,n=e.windowDays??30,r=Date.now()-n*24*60*60*1e3,o=t.prepare(`
    SELECT
      id,
      pending_message_id,
      decision_id,
    ...
    ORDER BY created_at_epoch DESC
    LIMIT ?
  `).all(r,s),i=0,a=0;for(let c of o){let d=Be(c.generated_observation_ids_json,[]);if(d.length===0||c.pending_message_id==null){a+=1;continue}let l=We(t,c.pending_message_id,d);if(l.length>0){i+=l.length;continue}a+=1}return u.debug("DB",`memory-assist-origins: backfill complete: resolved=${i} unresolved=${a}`),{resolvedCount:i,unresolvedCount:a}}function hn(t){return{id:t.id,project:t.project,source:t.source,semanticThreshold:t.semantic_threshold,injectLimit:t.inject_limit,minQueryLength:t.min_query_length,rankerId:t.ranker_id,createdAtEpoch:t.created_at_epoch,updatedAtEpoch:t.updated_at_epoch}}function Xt(t){t.run(`
  ...
  `).all(),s={global:null,byProject:{},bySource:{},byProjectAndSource:{}};for(let n of e){let r=hn(n);if(!r.project&&!r.source){s.global??=r;continue}if(r.project&&r.source){s.byProjectAndSource[`${r.project}::${r.source}`]=r;continue}if(r.project){s.byProject[r.project]=r;continue}r.source&&(s.bySource[r.source]=r)}return u.debug(`[memory-assist-calibration] loaded ${e.length} calibration rows`),s}function Ht(t,e,s,n){t.prepare(`PRAGMA table_info(${e})`).all().some(o=>o.name===s)||t.run(`ALTER TABLE ${e} ADD COLUMN ${s} ${n}`)}function Bt(t){t.run(`
  ...
  `).all(...o),a={total:i.reduce((c,d)=>c+d.count,0),aliases:i.map(c=>({originalType:c.original_type,normalizedType:c.normalized_type,count:c.count}))};return u.debug(`[memory-assist-taxonomy] loaded correction stats for ${e}d window (${a.total} corrections)`),a}var Vt=G(require("path"),1);var U=require("fs"),se=require("path"),Ye=require("os"),j=class{static DEFAULTS={CLAUDE_MEM_MODEL:"claude-sonnet-4-6",CLAUDE_MEM_CONTEXT_OBSERVATIONS:"50",CLAUDE_MEM_WORKER_PORT:"37777",CLAUDE_MEM_WORKER_HOST:"127.0.0.1",CLAUDE_MEM_SKIP_TOOLS:"ListMcpResourcesTool,SlashCommand,Skill,TodoWrite,AskUserQuestion",CLAUDE_MEM_PROVIDER:"claude",CLAUDE_MEM_CLAUDE_AUTH_METHOD:"cli",CLAUDE_MEM_GEMINI_API_KEY:"",CLAUDE_MEM_GEMINI_MODEL:"gemini-2.5-flash-lite",CLAUDE_MEM_GEMINI_RATE_LIMITING_ENABLED:"true",CLAUDE_MEM_GEMINI_MAX_CONTEXT_MESSAGES:"20",CLAUDE_MEM_GEMINI_MAX_TOKENS:"100000",CLAUDE_MEM_OPENROUTER_API_KEY:"",CLAUDE_MEM_OPENROUTER_MODEL:"xiaomi/mimo-v2-flash:free",CLAUDE_MEM_OPENROUTER_SITE_URL:"",CLAUDE_MEM_OPENROUTER_APP_NAME:"claude-mem",CLAUDE_MEM_OPENROUTER_MAX_CONTEXT_MESSAGES:"20",CLAUDE_MEM_OPENROUTER_MAX_TOKENS:"100000",CLAUDE_MEM_CUSTOM_BASE_URL:"",CLAUDE_MEM_CUSTOM_API_KEY:"",CLAUDE_MEM_CUSTOM_MODEL:"",CLAUDE_MEM_CUSTOM_MAX_CONTEXT_MESSAGES:"20",CLAUDE_MEM_CUSTOM_MAX_TOKENS:"100000",CLAUDE_MEM_CUSTOM_TEMPERATURE:"",CLAUDE_MEM_CUSTOM_MAX_OUTPUT_TOKENS:"",CLAUDE_MEM_DATA_DIR:(0,se.join)((0,Ye.homedir)(),".claude-mem"),CLAUDE_MEM_LOG_LEVEL:"INFO",CLAUDE_MEM_PYTHON_VERSION:"3.13",CLAUDE_CODE_PATH:"",CLAUDE_MEM_MODE:"code",CLAUDE_MEM_CONTEXT_SHOW_READ_TOKENS:"false",CLAUDE_MEM_CONTEXT_SHOW_WORK_TOKENS:"false",CLAUDE_MEM_CONTEXT_SHOW_SAVINGS_AMOUNT:"false",CLAUDE_MEM_CONTEXT_SHOW_SAVINGS_PERCENT:"true",CLAUDE_MEM_CONTEXT_FULL_COUNT:"0",CLAUDE_MEM_CONTEXT_FULL_FIELD:"narrative",CLAUDE_MEM_CONTEXT_SESSION_COUNT:"10",CLAUDE_MEM_CONTEXT_SHOW_LAST_SUMMARY:"true",CLAUDE_MEM_CONTEXT_SHOW_LAST_MESSAGE:"false",CLAUDE_MEM_CONTEXT_SHOW_TERMINAL_OUTPUT:"true",CLAUDE_MEM_FOLDER_CLAUDEMD_ENABLED:"false",CLAUDE_MEM_FOLDER_USE_LOCAL_MD:"false",CLAUDE_MEM_TRANSCRIPTS_ENABLED:"true",CLAUDE_MEM_TRANSCRIPTS_CONFIG_PATH:(0,se.join)((0,Ye.homedir)(),".claude-mem","transcript-watch.json"),CLAUDE_MEM_MAX_CONCURRENT_AGENTS:"2",CLAUDE_MEM_EXCLUDED_PROJECTS:"",CLAUDE_MEM_FOLDER_MD_EXCLUDE:"[]",CLAUDE_MEM_SEMANTIC_INJECT:"false",CLAUDE_MEM_SEMANTIC_INJECT_LIMIT:"5",CLAUDE_MEM_SEMANTIC_INJECT_THRESHOLD:"0.35",CLAUDE_MEM_SEMANTIC_INJECT_SUMMARY_THRESHOLD:"0.65",CLAUDE_MEM_RECOMMENDER_PAUSED:"true",CLAUDE_MEM_TIER_ROUTING_ENABLED:"true",CLAUDE_MEM_TIER_SIMPLE_MODEL:"haiku",CLAUDE_MEM_TIER_SUMMARY_MODEL:"",CLAUDE_MEM_CHROMA_ENABLED:"true",CLAUDE_MEM_CHROMA_MODE:"local",CLAUDE_MEM_CHROMA_HOST:"127.0.0.1",CLAUDE_MEM_CHROMA_PORT:"8000",CLAUDE_MEM_CHROMA_SSL:"false",CLAUDE_MEM_CHROMA_API_KEY:"",CLAUDE_MEM_CHROMA_TENANT:"default_tenant",CLAUDE_MEM_CHROMA_DATABASE:"default_database"};static getAllDefaults(){return{...this.DEFAULTS}}static get(e){return process.env[e]??this.DEFAULTS[e]}static getInt(e){let s=this.get(e);return parseInt(s,10)}static getBool(e){let s=this.get(e);return s==="true"||s===!0}static applyEnvOverrides(e){let s={...e};for(let n of Object.keys(this.DEFAULTS))process.env[n]!==void 0&&(s[n]=process.env[n]);return s}static loadFromFile(e){try{if(!(0,U.existsSync)(e)){let i=this.getAllDefaults();try{let a=(0,se.dirname)(e);(0,U.existsSync)(a)||(0,U.mkdirSync)(a,{recursive:!0}),(0,U.writeFileSync)(e,JSON.stringify(i,null,2),"utf-8"),console.log("[SETTINGS] Created settings file with defaults:",e)}catch(a){console.warn("[SETTINGS] Failed to create settings file, using in-memory defaults:",e,a instanceof Error?a.message:String(a))}return this.applyEnvOverrides(i)}let s=(0,U.readFileSync)(e,"utf-8"),n=JSON.parse(s),r=n;if(n.env&&typeof n.env=="object"){r=n.env;try{(0,U.writeFileSync)(e,JSON.stringify(r,null,2),"utf-8"),console.log("[SETTINGS] Migrated settings file from nested to flat schema:",e)}catch(i){console.warn("[SETTINGS] Failed to auto-migrate settings file:",e,i instanceof Error?i.message:String(i))}}let o={...this.DEFAULTS};for(let i of Object.keys(this.DEFAULTS))r[i]!==void 0&&(o[i]=r[i]);return this.applyEnvOverrides(o)}catch(s){return console.warn("[SETTINGS] Failed to load settings, using defaults:",e,s instanceof Error?s.message:String(s)),this.applyEnvOverrides(this.getAllDefaults())}}};var Yt="awaiting content-reuse signal";function qt(){if(process.env.CLAUDE_MEM_RECOMMENDER_PAUSED!==void 0)return process.env.CLAUDE_MEM_RECOMMENDER_PAUSED==="true";try{let t=Vt.default.join(j.get("CLAUDE_MEM_DATA_DIR"),"settings.json");return j.loadFromFile(t).CLAUDE_MEM_RECOMMENDER_PAUSED==="true"}catch{return j.getBool("CLAUDE_MEM_RECOMMENDER_PAUSED")}}function D(t,e){return e<=0?null:Math.round(t/e*100)}function Ke(t){return Math.round(t*10)/10}function Sn(t){let e=new Map;for(let s of t)s.status==="skipped"&&e.set(s.reason,(e.get(s.reason)??0)+1);return Array.from(e.entries()).sort((s,n)=>n[1]-s[1]||s[0].localeCompare(n[0])).slice(0,5).map(([s,n])=>({reason:s,count:n}))}function On(t){let e={likely_helped:0,unclear:0,likely_not_helped:0};for(let s of t)s.systemVerdict&&(e[s.systemVerdict]+=1);return e}function Rn(t,e){return t.length!==e.length?!1:t.every((s,n)=>s===e[n])}function yn(t,e){let s=new Set(t),n=new Set(e),r=new Set([...s,...n]);return r.size===0?100:[...s].filter(i=>n.has(i)).length/r.size*100}function Jt(t){let e=t.filter(i=>i.source==="semantic_prompt"&&i.shadowRanking?.experimentalSelectedObservationIds&&i.shadowRanking.productionSelectedObservationIds);if(e.length===0)return null;let s=0,n=0,r=0,o=0;for(let i of e){let a=[...i.shadowRanking?.productionSelectedObservationIds??[]].sort((d,l)=>d-l),c=[...i.shadowRanking?.experimentalSelectedObservationIds??[]].sort((d,l)=>d-l);if(Rn(a,c)&&(s+=1),n+=yn(a,c),i.systemVerdict==="likely_helped"){o+=1;let d=new Set((i.traceItems??[]).map(p=>p.observationId));c.some(p=>d.has(p))&&(r+=1)}}return{totalCompared:e.length,exactMatches:s,exactMatchRate:D(s,e.length),divergentSelections:e.length-s,avgSelectionOverlapRate:Ke(n/e.length),likelyHelpedWithExperimentalOverlap:r,likelyHelpedWithExperimentalOverlapRate:D(r,o)}}function An(t,e){if(qt())return{kind:"paused",reason:Yt,slice:e};if(t.actionable<20)return{kind:"insufficient_data",reason:"Need at least 20 actionable decisions before making a threshold recommendation.",confidence:.35,suggestedDelta:null,actionable:t.actionable,slice:e};let s=t.topSkipReasons.find(o=>o.reason==="below_threshold")?.count??0,n=s>0&&s>=Math.ceil(t.actionable*.25),r=(t.shadowRanking?.divergentSelections??0)>0||(t.shadowRanking?.likelyHelpedWithExperimentalOverlap??0)>0;return(t.injectRate??0)>=40&&(t.likelyHelpedRate??0)<=10?{kind:"lower_threshold",reason:"Injection volume is high, but few recalls are being judged helpful. Tighten the threshold slightly.",confidence:.8,suggestedDelta:-.05,actionable:t.actionable,slice:e}:(t.injectRate??0)<=5&&n&&r?{kind:"raise_threshold",reason:"Below-threshold skips dominate this slice and shadow ranking shows missed alternatives. Loosen the threshold slightly.",confidence:.72,suggestedDelta:.05,actionable:t.actionable,slice:e}:{kind:"keep_threshold",reason:"This slice looks balanced enough to keep the current threshold for now.",confidence:.58,suggestedDelta:0,actionable:t.actionable,slice:e}}function Ae(t,e,s,n=null){let r=t.length,o=t.filter(h=>h.status==="injected").length,i=t.filter(h=>h.status==="skipped").length,a=t.filter(h=>h.status==="disabled").length,c=t.filter(h=>h.status==="error").length,d=o+i,l=On(t),p=l.likely_helped,g=t.filter(h=>h.userFeedback==="helpful").length,b=t.filter(h=>h.userFeedback==="not_helpful").length,y=t.reduce((h,C)=>h+(C.estimatedInjectedTokens??0),0),N=p,E=D(p,o),T=n??r,f=e==null?null:D(e,T),R={total:r,actionable:d,injected:o,injectRate:D(o,d),likelyHelped:p,likelyHelpedRate:D(p,d),userConfirmedHelpful:g,userConfirmedHelpfulRate:D(g,g+b),helped:N,checkedNoHelp:Math.max(o-N,0),disabled:a,errors:c,helpRate:E,topSkipReasons:Sn(t),verdicts:l,estimatedInjectedTokens:y,helpfulRecallsPer1kInjectedTokens:y>0?Ke(p/y*1e3):null,injectedTokensPerLikelyHelpedRecall:p>0?Ke(y/p):null,taxonomyCorrectionCount:e,taxonomyCorrectionRate:f,shadowRanking:Jt(t)};return{...R,recommendation:An(R,s)}}function Kt(t,e,s){let n=Date.now()-e*24*60*60*1e3,r=s?"SELECT COUNT(*) as c FROM observations WHERE created_at_epoch >= ? AND project = ?":"SELECT COUNT(*) as c FROM observations WHERE created_at_epoch >= ?";return(s?t.prepare(r).get(n,s):t.prepare(r).get(n)).c}function qe(t,e,s,n=null){return{source:t,...Ae(e,s,{scope:"source",key:t,source:t},n)}}function Nn(t,e,s,n=null){return{project:t,...Ae(e,s,{scope:"project",key:t,project:t},n)}}function In(t,e,s,n){return{project:t,source:e,...Ae(s,n,{scope:"project_source",key:`${t}::${e}`,project:t,source:e})}}function vn(t,e){let s=t.prepare(`
  ...
  `).all(e),n={};for(let b of s)n[b.signal_kind]=b.cnt;let o=t.prepare(`
  ...
  `).get(e).cnt,a=t.prepare(`
    ...
    WHERE d.status = 'injected' AND d.created_at_epoch >= ?
  `).get(e).cnt,c=n.file_reuse??0,d=n.content_cited??0,l=n.no_overlap??0,p=Math.max(0,o-a),g=c+d;return{file_reuse:c,content_cited:d,no_overlap:l,not_yet_computed:p,implicitUseRate:D(g,a)}}function zt(t,e,s=30){let n=e.filter(S=>S.source==="semantic_prompt"),r=e.filter(S=>S.source==="semantic_summary"),o=e.filter(S=>S.source==="file_context"),i=e.filter(S=>S.status==="injected").length,a=e.filter(S=>S.status==="skipped").length,c=i+a,d=e.filter(S=>S.systemVerdict==="likely_helped").length,l=fe(t,s),p=Ve(t,s),g=e.filter(S=>S.userFeedback==="helpful").length,b=e.filter(S=>S.userFeedback==="not_helpful").length,y=Date.now()-s*24*60*60*1e3,N=Kt(t,s),E=vn(t,y),T=Ae(e,p.total,{scope:"global",key:"global"},N),f=[...new Set(e.map(S=>S.project).filter(S=>typeof S=="string"&&S.length>0))].sort((S,X)=>S.localeCompare(X)),R=Object.fromEntries(f.map(S=>{let X=e.filter(de=>de.project===S),xe=Ve(t,s,{project:S}),it=Kt(t,s,S);return[S,Nn(S,X,xe.total,it)]})),h=f.flatMap(S=>["semantic_prompt","semantic_summary","file_context"].map(X=>{let xe=e.filter(de=>de.project===S&&de.source===X);return[`${S}::${X}`,In(S,X,xe,null)]})),C={semantic_prompt:qe("semantic_prompt",n,null),semantic_summary:qe("semantic_summary",r,null),file_context:qe("file_context",o,null)},M=Date.now()-3600*1e3,I=e.filter(S=>S.createdAtEpoch>=M),P=I.filter(S=>S.status==="injected").length,_=I.filter(S=>S.status==="skipped").length,O=P+_,J=I.filter(S=>S.systemVerdict==="likely_helped").length,we={sinceEpoch:M,totalDecisions:I.length,injectRate:D(P,O),likelyHelpedRate:D(J,O),injected:P,actionable:O},Qs={windowDays:s,totalDecisions:e.length,injected:i,injectRate:D(i,c),likelyHelped:d,likelyHelpedRate:D(d,c),recentTrend:we,userConfirmedHelpfulRate:D(g,g+b),estimatedInjectedTokens:T.estimatedInjectedTokens,helpfulRecallsPer1kInjectedTokens:T.helpfulRecallsPer1kInjectedTokens,injectedTokensPerLikelyHelpedRecall:T.injectedTokensPerLikelyHelpedRecall,taxonomyCorrectionRate:T.taxonomyCorrectionRate,helped:d,checkedNoHelp:Math.max(i-d,0),helpRate:D(d,i),feedback:l,helpful:l.helpful,notHelpful:l.notHelpful,bySource:l.bySource,sourceStats:C,projectStats:R,projectSourceStats:Object.fromEntries(h),availableProjects:f,taxonomyCorrections:p,shadowRanking:Jt(n),recommendation:T.recommendation,implicitUseRate:E.implicitUseRate,implicitUseCounts:{file_reuse:E.file_reuse,content_cited:E.content_cited,no_overlap:E.no_overlap,not_yet_computed:E.not_yet_computed}};return u.debug("DB",`memory-assist-dashboard: built for ${s}d window using ${e.length} decisions across ${f.length} projects`),Qs}function w(t,e){return u.debug(`[MemoryAssistJudge] decision=${t.id??"new"} source=${t.source} status=${t.status} verdict=${e.verdict} confidence=${e.confidence.toFixed(2)}`),e}function ne(){return{matchedTracePaths:[],usedOutcomes:[],ignoredOutcomes:[]}}function k(t){return t?t.replace(/\\/g,"/").trim().toLowerCase():null}function Cn(t){let e=new Set;for(let s of t.traceItems??[]){let n=k(s.filePath);n&&e.add(n);for(let r of s.relatedFilePaths??[]){let o=k(r);o&&e.add(o)}}return e}function Mn(t){let e=new Set;for(let s of t){let n=k(s.filePath);n&&e.add(n);for(let r of s.relatedFilePaths??[]){let o=k(r);o&&e.add(o)}}return e}function K(t,e){let s=new Set,n=k(t.filePath);n&&e.has(n)&&s.add(n);for(let r of t.relatedFilePaths??[]){let o=k(r);o&&e.has(o)&&s.add(o)}return[...s]}function Dn(t,e,s){let n=new Set(e.generatedObservationIds??[]),r=new Set(s),o=new Set;for(let i of t.traceItems??[]){if(n.has(i.observationId)){o.add(i.observationId);continue}let a=k(i.filePath);if(a&&r.has(a)){o.add(i.observationId);continue}(i.relatedFilePaths??[]).some(d=>{let l=k(d);return l!=null&&r.has(l)})&&o.add(i.observationId)}return[...o]}function Ln(t,e){let s=new Set((e.concepts??[]).map(r=>r.trim().toLowerCase()).filter(Boolean));if(s.size===0)return 0;let n=new Set;for(let r of t.traceItems??[])for(let o of r.concepts??[]){let i=o.trim().toLowerCase();i&&s.has(i)&&n.add(i)}return n.size}function re(t,e){return(t.generatedObservationIds??[]).some(s=>e.has(s))}function es(t){return new Set(t)}function ts(t,e){return e.size===0?!1:K(t,e).some(s=>e.has(s))}function W(t,e,s,n){let r=es(s);return r.size===0?!1:e.some(o=>o===t||!n.includes(o.action)||(o.timestamp??0)>(t.timestamp??0)?!1:ts(o,r))}function ss(t,e,s,n){let r=es(s);return r.size===0?!1:e.some(o=>o===t||!n.includes(o.action)||(o.timestamp??0)<(t.timestamp??0)?!1:ts(o,r))}function wn(t,e,s){return t.action==="browser"?"browser_follow_up":t.action==="command"?W(t,e,s,["edit","write"])?"terminal_follow_up":"other_follow_up":t.action==="read"?ss(t,e,s,["edit","write"])?"follow_up_read":"other_follow_up":(t.action==="edit"||t.action==="write")&&W(t,e,s,["read"])?"follow_up_edit":"other_follow_up"}function Qt(t,e,s,n,r,o){let i=Dn(t,e,n),a=Ln(t,e),c=wn(e,s,n),d=(e.generatedObservationIds?.length??0)>0?"exact_observation_link":c==="follow_up_edit"||c==="terminal_follow_up"?"sequence_only":e.action==="browser"?"browser_only":n.length>0?"file_overlap":"no_overlap",l=d==="exact_observation_link"?o?"primary":"supporting":d==="sequence_only"?o?"supporting":"context":d==="file_overlap"&&o?"supporting":"context";return{outcomeId:e.id,pendingMessageId:e.pendingMessageId??null,action:e.action,toolName:e.toolName,filePath:e.filePath??null,timestamp:e.timestamp,matchedPaths:n,matchedTraceObservationIds:i,generatedObservationIds:e.generatedObservationIds??[],conceptOverlapCount:a,sequenceRole:c,signalSource:d,evidenceStrength:l,reason:r}}function Zt(t,e){return e.includes(t.action)}function B(t,e,s,n,r,o){let i=[],a=[];for(let c of e){let d=K(c,s);if(n(c,d)){i.push(Qt(t,c,e,d,r(c,d),!0));continue}a.push(Qt(t,c,e,d,o(c,d),!1))}return{matchedTracePaths:[...s],usedOutcomes:i,ignoredOutcomes:a}}function ns(t,e,s=t.userFeedback){if(s==="helpful")return w(t,{verdict:"likely_helped",confidence:.98,reasons:["User marked this memory assist as helpful."],evidence:ne()});if(s==="not_helpful")return w(t,{verdict:"likely_not_helped",confidence:.98,reasons:["User marked this memory assist as not helpful."],evidence:ne()});if(t.status!=="injected")return w(t,{verdict:"unclear",confidence:.4,reasons:["No memory was injected, so there is no direct adoption signal to judge."],evidence:ne()});if(e.length===0)return w(t,{verdict:"unclear",confidence:.35,reasons:["No follow-up tool actions were recorded after this injection."],evidence:ne()});if((t.traceItems?.length??0)===0&&(t.selectedCount??0)>0)return w(t,{verdict:"unclear",confidence:.3,reasons:["Summary injections have no file-path signals; adoption cannot be measured without explicit feedback."],evidence:ne()});let r=t.promptNumber??null,o=new Set((t.traceItems??[]).map(_=>k(_.filePath)).filter(_=>!!_)),i=e.filter(_=>{if(_.action!=="read"||r==null||_.promptNumber==null||_.promptNumber!==r)return!0;let O=k(_.filePath);return O?!o.has(O):!0}),a=Cn(t),c=Mn(e),d=[...a].filter(_=>c.has(_)),l=d.length,p=new Set(d),g=e.filter(_=>K(_,p).length>0),b=g.filter(_=>_.action==="edit"||_.action==="write").length,y=i.filter(_=>_.action==="read"&&K(_,p).length>0).length,N=e.filter(_=>_.action==="browser").length,E=g.filter(_=>(_.generatedObservationIds?.length??0)>0).length,T=new Set((t.traceItems??[]).map(_=>_.observationId)),f=e.filter(_=>re(_,T)),R=f.length,h=f.filter(_=>_.action==="edit"||_.action==="write").length,C=f.filter(_=>_.action==="read").length,M=g.filter(_=>(_.action==="edit"||_.action==="write")&&W(_,g,K(_,p),["read"])).length,I=g.filter(_=>_.action==="command"&&W(_,g,K(_,p),["edit","write"])).length;return h>0?w(t,{verdict:"likely_helped",confidence:M>0?.96:.9,reasons:[`${h} follow-up edit/write action${h===1?"":"s"} generated observations that were reused directly in the trace.`,...M>0?[`${M} of those edit/write action${M===1?"":"s"} followed a prior read on the same file.`]:[],...I>0?[`${I} same-target command follow-up${I===1?"":"s"} landed after an edit/write action.`]:[],"This is stronger evidence than plain file overlap because the exact generated observation linked back into the final trace."],evidence:B(t,e,p,(_,O)=>re(_,T)&&Zt(_,["edit","write"]),(_,O)=>{let J=W(_,e,O,["read"]);return`Primary evidence: this ${_.action==="write"?"write":"edit"} generated observation content that was reused directly in the trace${J?", and it followed a same-target read":""}.`},(_,O)=>re(_,T)?"Ignored by verdict because only edit/write actions count as adoption in this branch.":O.length>0?"Ignored by verdict because exact trace reuse outranked plain file overlap in this branch.":"Ignored by verdict because it did not generate trace-reused observations or overlap the injected memory paths.")}):C>0?w(t,{verdict:"likely_helped",confidence:.78,reasons:[`${C} follow-up read action${C===1?"":"s"} generated observations that were reused directly in the trace.`,"This is stronger evidence than plain file overlap, but weaker than seeing the same target edited afterward."],evidence:B(t,e,p,_=>re(_,T)&&_.action==="read",()=>"Primary evidence: this read generated observation content that was reused directly in the trace.",(_,O)=>re(_,T)?"Ignored by verdict because only read-based exact trace reuse counted in this branch.":O.length>0?"Ignored by verdict because exact trace reuse outranked plain file overlap in this branch.":"Ignored by verdict because it did not generate trace-reused observations or overlap the injected memory paths.")}):l>0&&b>0?w(t,{verdict:"likely_helped",confidence:R>0?.94:I>0?.91:E>0||M>0?.9:.88,reasons:[`Injected memory overlapped with ${l} file path${l===1?"":"s"} touched afterward.`,`${b} follow-up edit/write action${b===1?"":"s"} used those same files.`,...M>0?[`${M} of those edit/write action${M===1?"":"s"} followed a prior read on the same file.`]:[],...E>0?[`${E} matching follow-up action${E===1?"":"s"} produced exact linked observation${E===1?"":"s"}.`]:[],...R>0?[`${R} follow-up action${R===1?"":"s"} generated observations that were reused directly in the trace.`]:[],...I>0?[`${I} same-target command follow-up${I===1?"":"s"} landed after an edit/write action.`]:[]],evidence:B(t,e,p,(_,O)=>O.length>0&&Zt(_,["edit","write"]),(_,O)=>{let J=W(_,e,O,["read"]),we=ss(_,e,O,["command"]);return`${(_.generatedObservationIds?.length??0)>0?"Primary":"Supporting"} evidence: it ${_.action==="write"?"wrote":"edited"} ${O.length===1?"the matched file":"matched files"}${(_.generatedObservationIds?.length??0)>0?` and generated ${_.generatedObservationIds.length} exact linked observation${_.generatedObservationIds.length===1?"":"s"}`:""}${J?", after a same-target read":""}${we?", with a same-target command follow-up afterward":""}.`},(_,O)=>O.length>0?`Ignored by verdict because only edit/write overlap counted here${(_.generatedObservationIds?.length??0)>0?", even though this tool action generated exact linked observations":""}.`:`Ignored by verdict because it did not overlap with the injected memory paths${(_.generatedObservationIds?.length??0)>0?", even though it generated exact linked observations":""}.`)}):I>0?w(t,{verdict:"likely_helped",confidence:.83,reasons:[`${I} same-target command follow-up${I===1?"":"s"} landed after an edit/write action on the matched files.`,"That is weaker than direct trace reuse, but stronger than plain overlap because the command followed work on the same target."],evidence:B(t,e,p,(_,O)=>_.action==="command"&&O.length>0&&W(_,e,O,["edit","write"]),(_,O)=>`Supporting evidence: this command followed an edit/write on ${O.length===1?"the matched file":"matched files"} and stayed on the same target set.`,(_,O)=>O.length>0?"Ignored by verdict because only same-target command follow-ups counted in this branch.":"Ignored by verdict because it did not stay on the injected memory target set.")}):l>0&&y>0&&(y>=2||E>0||R>0)?w(t,{verdict:"likely_helped",confidence:R>0?.84:E>0?.78:.74,reasons:[`Injected memory overlapped with ${l} file path${l===1?"":"s"} revisited afterward.`,`${y} follow-up read action${y===1?"":"s"} revisited the same files.`,...E>0?[`${E} matching follow-up action${E===1?"":"s"} produced exact linked observation${E===1?"":"s"}.`]:[],...R>0?[`${R} follow-up action${R===1?"":"s"} generated observations that were reused directly in the trace.`]:[]],evidence:B(t,e,p,(_,O)=>O.length>0&&_.action==="read",(_,O)=>`${(_.generatedObservationIds?.length??0)>0?"Primary":"Supporting"} evidence: it reread ${O.length===1?"the matched file":"matched files"}${(_.generatedObservationIds?.length??0)>0?` and generated ${_.generatedObservationIds.length} exact linked observation${_.generatedObservationIds.length===1?"":"s"}`:""}.`,(_,O)=>O.length>0?`Ignored by verdict because only read overlap counted in this branch${(_.generatedObservationIds?.length??0)>0?", even though this tool action generated exact linked observations":""}.`:`Ignored by verdict because it did not overlap with the injected memory paths${(_.generatedObservationIds?.length??0)>0?", even though it generated exact linked observations":""}.`)}):N>0?w(t,{verdict:"unclear",confidence:.46,reasons:["The follow-up signal was mostly browser/UI activity, which is weaker evidence than file overlap."],evidence:B(t,e,p,_=>_.action==="browser",()=>"Context-only evidence: browser/UI follow-up was the only available signal.",(_,O)=>O.length>0?"Ignored by verdict because browser/UI activity took precedence in this branch.":"Ignored by verdict because it did not overlap with the injected memory paths.")}):w(t,{verdict:"likely_not_helped",confidence:.62,reasons:["The injection was not followed by related file overlap or a concrete follow-up action."],evidence:B(t,e,p,()=>!1,()=>"Unused.",(_,O)=>O.length>0?"Ignored by verdict because there was overlap, but no qualifying follow-up action.":"Ignored by verdict because it did not overlap with the injected memory paths.")})}function Ne(t){return t?t.replace(/\\/g,"/").trim().toLowerCase():null}function xn(t){let e=new Set,s=Ne(t.filePath);s&&e.add(s);for(let n of t.relatedFilePaths??[]){let r=Ne(n);r&&e.add(r)}return e}function Un(t){let e=new Set;for(let s of t.traceItems??[]){let n=Ne(s.filePath);n&&e.add(n);for(let r of s.relatedFilePaths??[]){let o=Ne(r);o&&e.add(o)}}return e}function Je(t){let e=t[0];for(let s=1;s<t.length;s++)t[s].createdAtEpoch>e.createdAtEpoch&&(e=t[s]);return e}function kn(t,e){let s=null,n=1/0;for(let r of t)if(r.createdAtEpoch<=e){let o=e-r.createdAtEpoch;o<n&&(s=r,n=o)}return s??Je(t)}function $n(t,e){return{customTitle:t,platformSource:e?Y(e):void 0}}var Ie=class{db;constructor(e=ut){e!==":memory:"&&_t(x),this.db=new rs.Database(e),this.db.run("PRAGMA journal_mode = WAL"),this.db.run("PRAGMA synchronous = NORMAL"),this.db.run("PRAGMA foreign_keys = ON"),this.db.run("PRAGMA journal_size_limit = 4194304"),this.initializeSchema(),this.ensureWorkerPortColumn(),this.ensurePromptTrackingColumns(),this.removeSessionSummariesUniqueConstraint(),this.addObservationHierarchicalFields(),this.makeObservationsTextNullable(),this.createUserPromptsTable(),this.ensureDiscoveryTokensColumn(),this.createPendingMessagesTable(),this.renameSessionIdColumns(),this.repairSessionIdColumnRename(),this.addFailedAtEpochColumn(),this.addOnUpdateCascadeToForeignKeys(),this.addObservationContentHashColumn(),this.addSessionCustomTitleColumn(),this.addSessionPlatformSourceColumn(),this.addObservationModelColumns(),this.ensureMergedIntoProjectColumns(),this.addObservationSubagentColumns(),this.ensureObservationFeedbackTable(),this.ensureMemoryAssistTables(),this.createObservationsFTSIndex(),this.addObservationDecisionDNAFields(),this.addCaptureSnapshotTables(),this.addObservationContextOriginFields(),this.addMcpInvocationsTable(),this.addMemoryImplicitSignalsTable(),this.addLlmRawTypeColumn()}createObservationsFTSIndex(){let e=this.db.prepare("SELECT name FROM sqlite_master WHERE type='table' AND name='observations_fts'").all().length>0;try{e||(this.db.run(`
    ...
    `).all(e)}getAllRecentUserPrompts(e=100){return this.db.prepare(`
      ...
      LIMIT ?
    `).all(e)}getAllProjects(e){let s=e?Y(e):void 0,n=`
      SELECT DISTINCT project
      FROM sdk_sessions
      WHERE project IS NOT NULL AND project != ''
        AND project != ?
    `,r=[Fe];return s&&(n+=" AND COALESCE(platform_source, ?) = ?",r.push(v,s)),n+=" ORDER BY project ASC",this.db.prepare(n).all(...r).map(i=>i.project)}getProjectCatalog(){let e=this.db.prepare(`
      SELECT
    ...
    `).run(i,e),i):null}listOrphanOutcomeSignalIds(e){return this.db.prepare(`
      ...
      WHERE decision_id IS NULL
        ...
        AND created_at_epoch >= ?
      ORDER BY created_at_epoch ASC
    `).all(e).map(n=>n.id)}attachGeneratedObservationsToOutcomeSignal(e,s){if(s.length===0)return null;let n=xt(this.db,e,s);if(n.length===0)return null;let r=this.db.prepare(`
      SELECT *
      FROM memory_assist_outcome_signals
      WHERE pending_message_id = ?
      ORDER BY id DESC
      LIMIT 1
    `).get(e);if(!r)return null;let o={id:r.id,decisionId:r.decision_id,pendingMessageId:e,source:r.source,promptNumber:r.prompt_number??void 0,contentSessionId:r.content_session_id??void 0,sessionDbId:r.session_db_id??void 0,project:r.project??void 0,platformSource:r.platform_source??void 0,signalType:r.signal_type,toolName:r.tool_name,action:r.action,filePath:r.file_path,relatedFilePaths:r.related_file_paths_json?JSON.parse(r.related_file_paths_json):[],concepts:r.concepts_json?JSON.parse(r.concepts_json):[],generatedObservationIds:n,metadata:r.metadata_json?JSON.parse(r.metadata_json):{},timestamp:r.created_at_epoch};return o.decisionId&&this.refreshMemoryAssistDecisionVerdict(o.decisionId),o}attachObservationOriginsToPendingMessage(e,s){return We(this.db,e,s)}insertContextOrigin(e,s,n,r){return Ft(this.db,e,s,n,r)}getObservationOrigins(e){return jt(this.db,e)}resolveMemoryAssistDecisionId(e){if(!e.contentSessionId||!e.promptNumber)return null;let s=e.timestamp??Date.now(),n=It(this.db,e.contentSessionId,e.promptNumber,900*1e3,s);if(n.length===0)return null;let r=n.filter(c=>c.status==="injected");if(r.length===0)return null;let o=xn(e),i=r.filter(c=>{if(c.source!=="file_context"||o.size===0)return!1;let d=Un(c);return[...o].some(l=>d.has(l))});if(i.length>0)return Je(i).id;let a=r.filter(c=>c.source==="semantic_prompt");return a.length>0?Je(a).id:kn(r,s).id}attachMemoryAssistDecisionFeedback(e,s){Ct(this.db,e,s),this.refreshMemoryAssistDecisionVerdict(e,s)}getMemoryAssistDashboard(e=30){let s=Z(this.db,{limit:1e4,windowDays:e});return zt(this.db,s,e)}backfillRecentFileContextTokenEstimates(e={}){let s=Z(this.db,{limit:e.limit??200,windowDays:e.windowDays??30,source:"file_context"}),n=0;for(let r of s){if(r.status!=="injected"||(r.estimatedInjectedTokens??0)>0)continue;let o=yt(r.traceItems,r.filePath);o<=0||(this.db.prepare(`
        UPDATE memory_assist_decisions
        SET estimated_injected_tokens = ?,
            updated_at_epoch = ?
        WHERE id = ?
      `).run(o,Date.now(),r.id),n+=1)}return u.debug("DB",`memory-assist-decisions: backfilled file-context token estimates for ${n} decisions`),{updatedCount:n}}backfillRecentMemoryAssistEvidence(e={}){return Z(this.db,{limit:e.limit??200,windowDays:e.windowDays??30}).map(r=>this.refreshMemoryAssistDecisionVerdict(r.id)??r)}backfillRecentObservationOrigins(e={}){return Pt(this.db,e)}getMemoryAssistCalibrationSnapshot(){return Gt(this.db)}recordObservationTypeCorrection(e){Wt(this.db,e)}refreshMemoryAssistDecisionVerdict(e,s){let[n]=He(this.db,[e]);if(!n)return null;let r=Ut(this.db,[e]),o=ns(n,r[e]??[],s);return vt(this.db,e,o.verdict,o.confidence,o.reasons,o.evidence),He(this.db,[e])[0]??null}getObservationsByIds(e,s={}){if(e.length===0)return[];let{orderBy:n="date_desc",limit:r,project:o,type:i,concepts:a,files:c}=s,d=n==="date_asc"?"ASC":"DESC",l=r?`LIMIT ${r}`:"",p=e.map(()=>"?").join(","),g=[...e],b=[];if(o&&(b.push("project = ?"),g.push(o)),i)if(Array.isArray(i)){let E=i.map(()=>"?").join(",");b.push(`type IN (${E})`),g.push(...i)}else b.push("type = ?"),g.push(i);if(a){let E=Array.isArray(a)?a:[a],T=E.map(()=>"EXISTS (SELECT 1 FROM json_each(concepts) WHERE value = ?)");g.push(...E),b.push(`(${T.join(" OR ")})`)}if(c){let E=Array.isArray(c)?c:[c],T=E.map(()=>"(EXISTS (SELECT 1 FROM json_each(files_read) WHERE value LIKE ?) OR EXISTS (SELECT 1 FROM json_each(files_modified) WHERE value LIKE ?))");E.forEach(f=>{g.push(`%${f}%`,`%${f}%`)}),b.push(`(${T.join(" OR ")})`)}let y=b.length>0?`WHERE id IN (${p}) AND ${b.join(" AND ")}`:`WHERE id IN (${p})`;return this.db.prepare(`
      SELECT *
      FROM observations
      ${y}
    ...
    `).get(e)||null}getFilesForSession(e){let n=this.db.prepare(`
      ...
      FROM observations
      WHERE memory_session_id = ?
    `).all(e),r=new Set,o=new Set;for(let i of n)Pe(i.files_read).forEach(a=>r.add(a)),Pe(i.files_modified).forEach(a=>o.add(a));return{filesRead:Array.from(r),filesModified:Array.from(o)}}getSessionById(e){return this.db.prepare(`
    ...
    `).get(e).count}createSDKSession(e,s,n,r,o){let i=new Date,a=i.getTime(),c=$n(r,o),d=c.platformSource??v,l=this.db.prepare(`
    ...
    `).get(e);if(l){if(s&&this.db.prepare(`
        ...
        `).run(c.customTitle,e),c.platformSource){let g=l.platform_source?.trim()?Y(l.platform_source):void 0;if(!g)this.db.prepare(`
    ...
    `).run(e,s,n,r.toISOString(),o).lastInsertRowid}getUserPrompt(e,s){return this.db.prepare(`
      ...
      LIMIT 1
    `).get(e,s)?.prompt_text??null}storeObservation(e,s,n,r,o=0,i,a,c){let d=i??Date.now(),l=new Date(d).toISOString(),p=pe(e,n.title,n.narrative),g=Ee(this.db,p,d);if(g)return{id:g.id,createdAtEpoch:g.created_at_epoch};let y=this.db.prepare(`
      INSERT INTO observations
      (memory_session_id, project, type, title, subtitle, facts, narrative, concepts,
       files_read, files_modified, prompt_number, discovery_tokens, agent_type, agent_id, content_hash, created_at, created_at_epoch,
       generated_by_model, why, alternatives_rejected, related_observation_ids)
      VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
    `).run(e,s,n.type,n.title,n.subtitle,JSON.stringify(n.facts),n.narrative,JSON.stringify(n.concepts),JSON.stringify(n.files_read),JSON.stringify(n.files_modified),r||null,o,n.agent_type??null,n.agent_id??null,p,l,d,a||null,n.why??null,n.alternatives_rejected??null,n.related_observation_ids&&n.related_observation_ids.length>0?JSON.stringify(n.related_observation_ids):null),N=Number(y.lastInsertRowid);return ge(this.db,N,c??Te(e,null,r??null),be(n),d),{id:N,createdAtEpoch:d}}storeSummary(e,s,n,r,o=0,i){let a=i??Date.now(),c=new Date(a).toISOString(),l=this.db.prepare(`
      INSERT INTO session_summaries
      (memory_session_id, project, request, investigated, learned, completed,
       next_steps, notes, prompt_number, discovery_tokens, created_at, created_at_epoch)
      VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
    `).run(e,s,n.request,n.investigated,n.learned,n.completed,n.next_steps,n.notes,r||null,o,c,a);return{id:Number(l.lastInsertRowid),createdAtEpoch:a}}storeObservations(e,s,n,r,o,i=0,a,c,d){let l=a??Date.now(),p=new Date(l).toISOString();return this.db.transaction(()=>{let b=[],y=this.db.prepare(`
        INSERT INTO observations
        (memory_session_id, project, type, title, subtitle, facts, narrative, concepts,
         files_read, files_modified, prompt_number, discovery_tokens, agent_type, agent_id, content_hash, created_at, created_at_epoch,
         generated_by_model, why, alternatives_rejected, related_observation_ids)
        VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
      `),N=d??Te(e,null,o??null);for(let T of n){let f=pe(e,T.title,T.narrative),R=Ee(this.db,f,l);if(R){b.push(R.id);continue}let h=y.run(e,s,T.type,T.title,T.subtitle,JSON.stringify(T.facts),T.narrative,JSON.stringify(T.concepts),JSON.stringify(T.files_read),JSON.stringify(T.files_modified),o||null,i,T.agent_type??null,T.agent_id??null,f,p,l,c||null,T.why??null,T.alternatives_rejected??null,T.related_observation_ids&&T.related_observation_ids.length>0?JSON.stringify(T.related_observation_ids):null),C=Number(h.lastInsertRowid);b.push(C),ge(this.db,C,N,be(T),l)}let E=null;if(r){let f=this.db.prepare(`
          INSERT INTO session_summaries
          (memory_session_id, project, request, investigated, learned, completed,
           next_steps, notes, prompt_number, discovery_tokens, created_at, created_at_epoch)
          VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
        `).run(e,s,r.request,r.investigated,r.learned,r.completed,r.next_steps,r.notes,o||null,i,p,l);E=Number(f.lastInsertRowid)}return{observationIds:b,summaryId:E,createdAtEpoch:l}})()}storeObservationsAndMarkComplete(e,s,n,r,o,i,a,c=0,d,l,p){let g=d??Date.now(),b=new Date(g).toISOString();return this.db.transaction(()=>{let N=[],E=this.db.prepare(`
        INSERT INTO observations
        (memory_session_id, project, type, title, subtitle, facts, narrative, concepts,
         files_read, files_modified, prompt_number, discovery_tokens, agent_type, agent_id, content_hash, created_at, created_at_epoch,
         generated_by_model, why, alternatives_rejected, related_observation_ids)
        VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
      `),T=p??Te(e,null,a??null);for(let h of n){let C=pe(e,h.title,h.narrative),M=Ee(this.db,C,g);if(M){N.push(M.id);continue}let I=E.run(e,s,h.type,h.title,h.subtitle,JSON.stringify(h.facts),h.narrative,JSON.stringify(h.concepts),JSON.stringify(h.files_read),JSON.stringify(h.files_modified),a||null,c,h.agent_type??null,h.agent_id??null,C,b,g,l||null,h.why??null,h.alternatives_rejected??null,h.related_observation_ids&&h.related_observation_ids.length>0?JSON.stringify(h.related_observation_ids):null),P=Number(I.lastInsertRowid);N.push(P),ge(this.db,P,T,be(h),g)}let f;if(r){let C=this.db.prepare(`
          INSERT INTO session_summaries
          (memory_session_id, project, request, investigated, learned, completed,
           next_steps, notes, prompt_number, discovery_tokens, created_at, created_at_epoch)
          VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
        `).run(e,s,r.request,r.investigated,r.learned,r.completed,r.next_steps,r.notes,a||null,c,b,g);f=Number(C.lastInsertRowid)}return this.db.prepare(`
      ...
      `).run(g,o),{observationIds:N,summaryId:f,createdAtEpoch:g}})()}getSessionSummariesByIds(e,s={}){if(e.length===0)return[];let{orderBy:n="date_desc",limit:r,project:o}=s,i=n==="date_asc"?"ASC":"DESC",a=r?`LIMIT ${r}`:"",c=e.map(()=>"?").join(","),d=[...e],l=o?`WHERE id IN (${c}) AND project = ?`:`WHERE id IN (${c})`;return o&&d.push(o),this.db.prepare(`
    ...
    `).all(...d)}getTimelineAroundTimestamp(e,s=10,n=10,r){return this.getTimelineAroundObservation(null,e,s,n,r)}getTimelineAroundObservation(e,s,n=10,r=10,o){let i=o?"AND project = ?":"",a=o?[o]:[],c,d;if(e!==null){let E=`
      ...
      `,T=`
        ...
        ORDER BY id ASC
        LIMIT ?
      `;try{let f=this.db.prepare(E).all(e,...a,n+1),R=this.db.prepare(T).all(e,...a,r+1);if(f.length===0&&R.length===0)return{observations:[],sessions:[],prompts:[]};c=f.length>0?f[f.length-1].created_at_epoch:s,d=R.length>0?R[R.length-1].created_at_epoch:s}catch(f){return f instanceof Error?u.error("DB","Error getting boundary observations",{project:o},f):u.error("DB","Error getting boundary observations with non-Error",{},new Error(String(f))),{observations:[],sessions:[],prompts:[]}}}else{let E=`
      ...
      `,T=`
        ...
        ORDER BY created_at_epoch ASC
        LIMIT ?
      `;try{let f=this.db.prepare(E).all(s,...a,n),R=this.db.prepare(T).all(s,...a,r+1);if(f.length===0&&R.length===0)return{observations:[],sessions:[],prompts:[]};c=f.length>0?f[f.length-1].created_at_epoch:s,d=R.length>0?R[R.length-1].created_at_epoch:s}catch(f){return f instanceof Error?u.error("DB","Error getting boundary timestamps",{project:o},f):u.error("DB","Error getting boundary timestamps with non-Error",{},new Error(String(f))),{observations:[],sessions:[],prompts:[]}}}let l=`
      SELECT *
      FROM observations
    ...
    `).get(e)||null}getOrCreateManualSession(e){let s=`manual-${e}`,n=`manual-content-${e}`;if(this.db.prepare("SELECT memory_session_id FROM sdk_sessions WHERE memory_session_id = ?").get(s))return s;let o=new Date;return this.db.prepare(`
      ...
      VALUES (?, ?, ?, ?, ?, ?, 'active')
    `).run(s,n,e,v,o.toISOString(),o.getTime()),u.info("SESSION","Created manual session",{memorySessionId:s,project:e}),s}getObservationRetrievalContext(e){let s=new Map;if(e.length===0)return s;let n=e.map(()=>"?").join(","),r=this.db.prepare(`
    ...
    `).run(e.content_session_id,e.prompt_number,e.prompt_text,e.created_at,e.created_at_epoch).lastInsertRowid}}};var os=G(require("path"),1),is=require("os");var oe=require("fs"),ve=require("path");var L=class t{static instance=null;activeMode=null;modesDir;constructor(){let e=mt(),s=[(0,ve.join)(e,"modes"),(0,ve.join)(e,"..","plugin","modes")],n=s.find(r=>(0,oe.existsSync)(r));this.modesDir=n||s[0]}static getInstance(){return t.instance||(t.instance=new t),t.instance}parseInheritance(e){let s=e.split("--");if(s.length===1)return{hasParent:!1,parentId:"",overrideId:""};if(s.length>2)throw new Error(`Invalid mode inheritance: ${e}. Only one level of inheritance supported (parent--override)`);return{hasParent:!0,parentId:s[0],overrideId:e}}isPlainObject(e){return e!==null&&typeof e=="object"&&!Array.isArray(e)}deepMerge(e,s){let n={...e};for(let r in s){let o=s[r],i=e[r];this.isPlainObject(o)&&this.isPlainObject(i)?n[r]=this.deepMerge(i,o):n[r]=o}return n}loadModeFile(e){let s=(0,ve.join)(this.modesDir,`${e}.json`);if(!(0,oe.existsSync)(s))throw new Error(`Mode file not found: ${s}`);let n=(0,oe.readFileSync)(s,"utf-8");return JSON.parse(n)}loadMode(e){let s=this.parseInheritance(e);if(!s.hasParent)try{let c=this.loadModeFile(e);return this.activeMode=c,u.debug("SYSTEM",`Loaded mode: ${c.name} (${e})`,void 0,{types:c.observation_types.map(d=>d.id),concepts:c.observation_concepts.map(d=>d.id)}),c}catch(c){if(c instanceof Error?u.warn("WORKER",`Mode file not found: ${e}, falling back to 'code'`,{message:c.message}):u.warn("WORKER",`Mode file not found: ${e}, falling back to 'code'`,{error:String(c)}),e==="code")throw new Error("Critical: code.json mode file missing");return this.loadMode("code")}let{parentId:n,overrideId:r}=s,o;try{o=this.loadMode(n)}catch(c){c instanceof Error?u.warn("WORKER",`Parent mode '${n}' not found for ${e}, falling back to 'code'`,{message:c.message}):u.warn("WORKER",`Parent mode '${n}' not found for ${e}, falling back to 'code'`,{error:String(c)}),o=this.loadMode("code")}let i;try{i=this.loadModeFile(r),u.debug("SYSTEM",`Loaded override file: ${r} for parent ${n}`)}catch(c){return c instanceof Error?u.warn("WORKER",`Override file '${r}' not found, using parent mode '${n}' only`,{message:c.message}):u.warn("WORKER",`Override file '${r}' not found, using parent mode '${n}' only`,{error:String(c)}),this.activeMode=o,o}if(!i)return u.warn("SYSTEM",`Invalid override file: ${r}, using parent mode '${n}' only`),this.activeMode=o,o;let a=this.deepMerge(o,i);return this.activeMode=a,u.debug("SYSTEM",`Loaded mode with inheritance: ${a.name} (${e} = ${n} + ${r})`,void 0,{parent:n,override:r,types:a.observation_types.map(c=>c.id),concepts:a.observation_concepts.map(c=>c.id)}),a}getActiveMode(){if(!this.activeMode)throw new Error("No mode loaded. Call loadMode() first.");return this.activeMode}getObservationTypes(){return this.getActiveMode().observation_types}getObservationConcepts(){return this.getActiveMode().observation_concepts}getTypeIcon(e){return this.getObservationTypes().find(n=>n.id===e)?.emoji||"\u{1F4DD}"}getWorkEmoji(e){return this.getObservationTypes().find(n=>n.id===e)?.work_emoji||"\u{1F4DD}"}validateType(e){return this.getObservationTypes().some(s=>s.id===e)}getTypeLabel(e){return this.getObservationTypes().find(n=>n.id===e)?.label||e}};function ze(){let t=os.default.join((0,is.homedir)(),".claude-mem","settings.json"),e=j.loadFromFile(t),s=L.getInstance().getActiveMode(),n=new Set(s.observation_types.map(o=>o.id)),r=new Set(s.observation_concepts.map(o=>o.id));return{totalObservationCount:parseInt(e.CLAUDE_MEM_CONTEXT_OBSERVATIONS,10),fullObservationCount:parseInt(e.CLAUDE_MEM_CONTEXT_FULL_COUNT,10),sessionCount:parseInt(e.CLAUDE_MEM_CONTEXT_SESSION_COUNT,10),showReadTokens:e.CLAUDE_MEM_CONTEXT_SHOW_READ_TOKENS==="true",showWorkTokens:e.CLAUDE_MEM_CONTEXT_SHOW_WORK_TOKENS==="true",showSavingsAmount:e.CLAUDE_MEM_CONTEXT_SHOW_SAVINGS_AMOUNT==="true",showSavingsPercent:e.CLAUDE_MEM_CONTEXT_SHOW_SAVINGS_PERCENT==="true",observationTypes:n,observationConcepts:r,fullObservationField:e.CLAUDE_MEM_CONTEXT_FULL_FIELD,showLastSummary:e.CLAUDE_MEM_CONTEXT_SHOW_LAST_SUMMARY==="true",showLastMessage:e.CLAUDE_MEM_CONTEXT_SHOW_LAST_MESSAGE==="true"}}var m={reset:"\x1B[0m",bright:"\x1B[1m",dim:"\x1B[2m",cyan:"\x1B[36m",green:"\x1B[32m",yellow:"\x1B[33m",blue:"\x1B[34m",magenta:"\x1B[35m",gray:"\x1B[90m",red:"\x1B[31m"},as=4,Qe=1;function Ze(t){let e=(t.title?.length||0)+(t.subtitle?.length||0)+(t.narrative?.length||0)+JSON.stringify(t.facts||[]).length;return Math.ceil(e/as)}function et(t){let e=t.length,s=t.reduce((i,a)=>i+Ze(a),0),n=t.reduce((i,a)=>i+(a.discovery_tokens||0),0),r=n-s,o=n>0?Math.round(r/n*100):0;return{totalObservations:e,totalReadTokens:s,totalDiscoveryTokens:n,savings:r,savingsPercent:o}}function Fn(t){return L.getInstance().getWorkEmoji(t)}function ie(t,e){let s=Ze(t),n=t.discovery_tokens||0,r=Fn(t.type),o=n>0?`${r} ${n.toLocaleString()}`:"-";return{readTokens:s,discoveryTokens:n,discoveryDisplay:o,workEmoji:r}}function Ce(t){return t.showReadTokens||t.showWorkTokens||t.showSavingsAmount||t.showSavingsPercent}var ds=G(require("path"),1),Me=require("fs");var cs=/<system-reminder>[\s\S]*?<\/system-reminder>/g;function tt(t,e,s,n){let r=Array.from(s.observationTypes),o=r.map(()=>"?").join(","),i=Array.from(s.observationConcepts),a=i.map(()=>"?").join(",");return t.db.prepare(`
    SELECT
      o.id,
      o.memory_session_id,
    ...
    ORDER BY o.created_at_epoch DESC
    LIMIT ?
  `).all(e,e,...r,...i,...n?[n]:[],s.totalObservationCount)}function st(t,e,s,n){return t.db.prepare(`
    SELECT
      ss.id,
    ...
    ORDER BY ss.created_at_epoch DESC
    LIMIT ?
  `).all(e,e,...n?[n]:[],s.sessionCount+Qe)}function ls(t,e,s,n){let r=Array.from(s.observationTypes),o=r.map(()=>"?").join(","),i=Array.from(s.observationConcepts),a=i.map(()=>"?").join(","),c=e.map(()=>"?").join(",");return t.db.prepare(`
    SELECT
      o.id,
      o.memory_session_id,
      COALESCE(s.platform_source, 'claude') as platform_source,
    ...
    ORDER BY o.created_at_epoch DESC
    LIMIT ?
  `).all(...e,...e,...r,...i,...n?[n]:[],s.totalObservationCount)}function us(t,e,s,n){let r=e.map(()=>"?").join(",");return t.db.prepare(`
    SELECT
      ss.id,
      ss.memory_session_id,
      COALESCE(s.platform_source, 'claude') as platform_source,
    ...
    ORDER BY ss.created_at_epoch DESC
    LIMIT ?
  `).all(...e,...e,...n?[n]:[],s.sessionCount+Qe)}function jn(t){return t.replace(/\//g,"-")}function Pn(t){if(!t.includes('"type":"assistant"'))return null;let e=JSON.parse(t);if(e.type==="assistant"&&e.message?.content&&Array.isArray(e.message.content)){let s="";for(let n of e.message.content)n.type==="text"&&(s+=n.text);if(s=s.replace(cs,"").trim(),s)return s}return null}function Xn(t){for(let e=t.length-1;e>=0;e--)try{let s=Pn(t[e]);if(s)return s}catch(s){s instanceof Error?u.debug("WORKER","Skipping malformed transcript line",{lineIndex:e},s):u.debug("WORKER","Skipping malformed transcript line",{lineIndex:e,error:String(s)});continue}return""}function Gn(t){try{if(!(0,Me.existsSync)(t))return{userMessage:"",assistantMessage:""};let e=(0,Me.readFileSync)(t,"utf-8").trim();if(!e)return{userMessage:"",assistantMessage:""};let s=e.split(`
`).filter(r=>r.trim());return{userMessage:"",assistantMessage:Xn(s)}}catch(e){return e instanceof Error?u.failure("WORKER","Failed to extract prior messages from transcript",{transcriptPath:t},e):u.warn("WORKER","Failed to extract prior messages from transcript",{transcriptPath:t,error:String(e)}),{userMessage:"",assistantMessage:""}}}function nt(t,e,s,n){if(!e.showLastMessage||t.length===0)return{userMessage:"",assistantMessage:""};let r=t.find(c=>c.memory_session_id!==s);if(!r)return{userMessage:"",assistantMessage:""};let o=r.memory_session_id,i=jn(n),a=ds.default.join(V,"projects",i,`${o}.jsonl`);return Gn(a)}function _s(t,e){let s=e[0]?.id;return t.map((n,r)=>{let o=r===0?null:e[r+1];return{...n,displayEpoch:o?o.created_at_epoch:n.created_at_epoch,displayTime:o?o.created_at:n.created_at,shouldShowLink:n.id!==s}})}function rt(t,e){let s=[...t.map(n=>({type:"observation",data:n})),...e.map(n=>({type:"summary",data:n}))];return s.sort((n,r)=>{let o=n.type==="observation"?n.data.created_at_epoch:n.data.displayEpoch,i=r.type==="observation"?r.data.created_at_epoch:r.data.displayEpoch;return o-i}),s}function ms(t,e){return new Set(t.slice(0,e).map(s=>s.id))}function ps(){let t=new Date,e=t.toLocaleDateString("en-CA"),s=t.toLocaleTimeString("en-US",{hour:"numeric",minute:"2-digit",hour12:!0}).toLowerCase().replace(" ",""),n=t.toLocaleTimeString("en-US",{timeZoneName:"short"}).split(" ").pop();return`${e} ${s} ${n}`}function Es(t){return[`# [${t}] recent context, ${ps()}`,""]}function gs(){return[`Legend: \u{1F3AF}session ${L.getInstance().getActiveMode().observation_types.map(s=>`${s.emoji}${s.id}`).join(" ")}`,"Format: ID TIME TYPE TITLE","Fetch details: get_observations([IDs]) | Search: mem-search skill",""]}function Ts(){return[]}function bs(){return[]}function fs(t,e){let s=[],n=[`${t.totalObservations} obs (${t.totalReadTokens.toLocaleString()}t read)`,`${t.totalDiscoveryTokens.toLocaleString()}t work`];return t.totalDiscoveryTokens>0&&(e.showSavingsAmount||e.showSavingsPercent)&&(e.showSavingsPercent?n.push(`${t.savingsPercent}% savings`):e.showSavingsAmount&&n.push(`${t.savings.toLocaleString()}t saved`)),s.push(`Stats: ${n.join(" | ")}`),s.push(""),s}function hs(t){return[`### ${t}`]}function Ss(t){return t.toLowerCase().replace(" am","a").replace(" pm","p")}function Os(t,e,s){let n=t.title||"Untitled",r=L.getInstance().getTypeIcon(t.type),o=e?Ss(e):'"';return`${t.id} ${o} ${r} ${n}`}function Rs(t,e,s,n){let r=[],o=t.title||"Untitled",i=L.getInstance().getTypeIcon(t.type),a=e?Ss(e):'"',{readTokens:c,discoveryDisplay:d}=ie(t,n);r.push(`**${t.id}** ${a} ${i} **${o}**`),s&&r.push(s);let l=[];return n.showReadTokens&&l.push(`~${c}t`),n.showWorkTokens&&l.push(d),l.length>0&&r.push(l.join(" ")),r.push(""),r}function ys(t,e){return[`S${t.id} ${t.request||"Session started"} (${e})`]}function ae(t,e){return e?[`**${t}**: ${e}`,""]:[]}function As(t){return t.assistantMessage?["","---","","**Previously**","",`A: ${t.assistantMessage}`,""]:[]}function Ns(t,e){return["",`Access ${Math.round(t/1e3)}k tokens of past work via get_observations([IDs]) or mem-search skill.`]}function Is(t){return`# [${t}] recent context, ${ps()}

No previous sessions found.`}function vs(){let t=new Date,e=t.toLocaleDateString("en-CA"),s=t.toLocaleTimeString("en-US",{hour:"numeric",minute:"2-digit",hour12:!0}).toLowerCase().replace(" ",""),n=t.toLocaleTimeString("en-US",{timeZoneName:"short"}).split(" ").pop();return`${e} ${s} ${n}`}function Cs(t){return["",`${m.bright}${m.cyan}[${t}] recent context, ${vs()}${m.reset}`,`${m.gray}${"\u2500".repeat(60)}${m.reset}`,""]}function Ms(){let e=L.getInstance().getActiveMode().observation_types.map(s=>`${s.emoji} ${s.id}`).join(" | ");return[`${m.dim}Legend: session-request | ${e}${m.reset}`,""]}function Ds(){return[`${m.bright}Column Key${m.reset}`,`${m.dim}  Read: Tokens to read this observation (cost to learn it now)${m.reset}`,`${m.dim}  Work: Tokens spent on work that produced this record ( research, building, deciding)${m.reset}`,""]}function Ls(){return[`${m.dim}Context Index: This semantic index (titles, types, files, tokens) is usually sufficient to understand past work.${m.reset}`,"",`${m.dim}When you need implementation details, rationale, or debugging context:${m.reset}`,`${m.dim}  - Fetch by ID: get_observations([IDs]) for observations visible in this index${m.reset}`,`${m.dim}  - Search history: Use the mem-search skill for past decisions, bugs, and deeper research${m.reset}`,`${m.dim}  - Trust this index over re-reading code for past decisions and learnings${m.reset}`,""]}function ws(t,e){let s=[];if(s.push(`${m.bright}${m.cyan}Context Economics${m.reset}`),s.push(`${m.dim}  Loading: ${t.totalObservations} observations (${t.totalReadTokens.toLocaleString()} tokens to read)${m.reset}`),s.push(`${m.dim}  Work investment: ${t.totalDiscoveryTokens.toLocaleString()} tokens spent on research, building, and decisions${m.reset}`),t.totalDiscoveryTokens>0&&(e.showSavingsAmount||e.showSavingsPercent)){let n="  Your savings: ";e.showSavingsAmount&&e.showSavingsPercent?n+=`${t.savings.toLocaleString()} tokens (${t.savingsPercent}% reduction from reuse)`:e.showSavingsAmount?n+=`${t.savings.toLocaleString()} tokens`:n+=`${t.savingsPercent}% reduction from reuse`,s.push(`${m.green}${n}${m.reset}`)}return s.push(""),s}function xs(t){return[`${m.bright}${m.cyan}${t}${m.reset}`,""]}function Us(t){return[`${m.dim}${t}${m.reset}`]}function ks(t,e,s,n){let r=t.title||"Untitled",o=L.getInstance().getTypeIcon(t.type),{readTokens:i,discoveryTokens:a,workEmoji:c}=ie(t,n),d=s?`${m.dim}${e}${m.reset}`:" ".repeat(e.length),l=n.showReadTokens&&i>0?`${m.dim}(~${i}t)${m.reset}`:"",p=n.showWorkTokens&&a>0?`${m.dim}(${c} ${a.toLocaleString()}t)${m.reset}`:"";return`  ${m.dim}#${t.id}${m.reset}  ${d}  ${o}  ${r} ${l} ${p}`}function $s(t,e,s,n,r){let o=[],i=t.title||"Untitled",a=L.getInstance().getTypeIcon(t.type),{readTokens:c,discoveryTokens:d,workEmoji:l}=ie(t,r),p=s?`${m.dim}${e}${m.reset}`:" ".repeat(e.length),g=r.showReadTokens&&c>0?`${m.dim}(~${c}t)${m.reset}`:"",b=r.showWorkTokens&&d>0?`${m.dim}(${l} ${d.toLocaleString()}t)${m.reset}`:"";return o.push(`  ${m.dim}#${t.id}${m.reset}  ${p}  ${a}  ${m.bright}${i}${m.reset}`),n&&o.push(`    ${m.dim}${n}${m.reset}`),(g||b)&&o.push(`    ${g} ${b}`),o.push(""),o}function Fs(t,e){let s=`${t.request||"Session started"} (${e})`;return[`${m.yellow}#S${t.id}${m.reset} ${s}`,""]}function ce(t,e,s){return e?[`${s}${t}:${m.reset} ${e}`,""]:[]}function js(t){return t.assistantMessage?["","---","",`${m.bright}${m.magenta}Previously${m.reset}`,"",`${m.dim}A: ${t.assistantMessage}${m.reset}`,""]:[]}function Ps(t,e){let s=Math.round(t/1e3);return["",`${m.dim}Access ${s}k tokens of past research & decisions for just ${e.toLocaleString()}t. Use the claude-mem skill to access memories by ID.${m.reset}`]}function Xs(t){return`
${m.bright}${m.cyan}[${t}] recent context, ${vs()}${m.reset}
${m.gray}${"\u2500".repeat(60)}${m.reset}

${m.dim}No previous sessions found for this project yet.${m.reset}
`}function Gs(t,e,s,n){let r=[];return n?r.push(...Cs(t)):r.push(...Es(t)),n?r.push(...Ms()):r.push(...gs()),n?r.push(...Ds()):r.push(...Ts()),n?r.push(...Ls()):r.push(...bs()),Ce(s)&&(n?r.push(...ws(e,s)):r.push(...fs(e,s))),r}function Hn(t){let e=new Map;for(let n of t){let r=n.type==="observation"?n.data.created_at:n.data.displayTime,o=Ge(r);e.has(o)||e.set(o,[]),e.get(o).push(n)}let s=Array.from(e.entries()).sort((n,r)=>{let o=new Date(n[0]).getTime(),i=new Date(r[0]).getTime();return o-i});return new Map(s)}function Hs(t,e){return e.fullObservationField==="narrative"?t.narrative:t.facts?Se(t.facts).join(`
`):null}function Bn(t,e,s,n){let r=[];r.push(...hs(t));let o="";for(let i of e)if(i.type==="summary"){let a=i.data,c=Xe(a.displayTime);r.push(...ys(a,c))}else{let a=i.data,c=Oe(a.created_at),l=c!==o?c:"";if(o=c,s.has(a.id)){let g=Hs(a,n);r.push(...Rs(a,l,g,n))}else r.push(Os(a,l,n))}return r}function Wn(t,e,s,n,r){let o=[];o.push(...xs(t));let i=null,a="";for(let c of e)if(c.type==="summary"){i=null,a="";let d=c.data,l=Xe(d.displayTime);o.push(...Fs(d,l))}else{let d=c.data,l=Rt(d.files_modified,r,d.files_read),p=Oe(d.created_at),g=p!==a;a=p;let b=s.has(d.id);if(l!==i&&(o.push(...Us(l)),i=l),b){let y=Hs(d,n);o.push(...$s(d,p,g,y,n))}else o.push(ks(d,p,g,n))}return o.push(""),o}function Vn(t,e,s,n,r,o){return o?Wn(t,e,s,n,r):Bn(t,e,s,n)}function Bs(t,e,s,n,r){let o=[],i=Hn(t);for(let[a,c]of i)o.push(...Vn(a,c,e,s,n,r));return o}function Ws(t,e,s){return!(!t.showLastSummary||!e||!!!(e.investigated||e.learned||e.completed||e.next_steps)||s&&e.created_at_epoch<=s.created_at_epoch)}function Vs(t,e){let s=[];return e?(s.push(...ce("Investigated",t.investigated,m.blue)),s.push(...ce("Learned",t.learned,m.yellow)),s.push(...ce("Completed",t.completed,m.green)),s.push(...ce("Next Steps",t.next_steps,m.magenta))):(s.push(...ae("Investigated",t.investigated)),s.push(...ae("Learned",t.learned)),s.push(...ae("Completed",t.completed)),s.push(...ae("Next Steps",t.next_steps))),s}function Ys(t,e){return e?js(t):As(t)}function qs(t,e,s){return!Ce(e)||t.totalDiscoveryTokens<=0||t.savings<=0?[]:s?Ps(t.totalDiscoveryTokens,t.totalReadTokens):Ns(t.totalDiscoveryTokens,t.totalReadTokens)}var Yn=Ks.default.join((0,Js.homedir)(),".claude","plugins","marketplaces","thedotmack","plugin",".install-version");function qn(){try{return new Ie}catch(t){if(t instanceof Error&&t.code==="ERR_DLOPEN_FAILED"){try{(0,zs.unlinkSync)(Yn)}catch(e){e instanceof Error?u.debug("WORKER","Marker file cleanup failed (may not exist)",{},e):u.debug("WORKER","Marker file cleanup failed (may not exist)",{error:String(e)})}return u.error("WORKER","Native module rebuild needed - restart Claude Code to auto-fix"),null}throw t}}function Kn(t,e){return e?Xs(t):Is(t)}function Jn(t,e,s,n,r,o,i){let a=[],c=et(e);a.push(...Gs(t,c,n,i));let d=s.slice(0,n.sessionCount),l=_s(d,s),p=rt(e,l),g=ms(e,n.fullObservationCount);a.push(...Bs(p,g,n,r,i));let b=s[0],y=e[0];Ws(n,b,y)&&a.push(...Vs(b,i));let N=nt(e,n,o,r);return a.push(...Ys(N,i)),a.push(...qs(c,n,i)),a.join(`
`).trimEnd()}async function ot(t,e=!1){let s=ze(),n=t?.cwd??process.cwd(),r=je(n),o=t?.platform_source,i=t?.projects?.length?t.projects:r.allProjects,a=i[i.length-1]??r.primary;t?.full&&(s.totalObservationCount=999999,s.sessionCount=999999);let c=qn();if(!c)return"";try{let d=i.length>1?ls(c,i,s,o):tt(c,a,s,o),l=i.length>1?us(c,i,s,o):st(c,a,s,o);return d.length===0&&l.length===0?Kn(a,e):Jn(a,d,l,s,n,t?.session_id,e)}finally{c.close()}}0&&(module.exports={generateContext});
